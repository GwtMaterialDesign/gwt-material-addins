                                ...
                                return (
                                    ("{bksp}" === t || "{backspace}" === t) && s.length > 0
                                        ...
                                        : "{space}" === t
                                            ...
                                            : "{tab}" !== t || ("boolean" === typeof i.tabCharOnTab && !1 === i.tabCharOnTab)
                                                ? ("{enter}" !== t && "{numpadenter}" !== t) || !i.newLineOnEnter
                                                                    ...
                                                                    : "{numpadadd}" === t
                                                                        ...
                                                                        : "{numpaddecimal}" === t
                                                                            ...
                                                                            : "{" === t || "}" === t
                                                                                ...
                                                                                : t.includes("{") || t.includes("}") || (s = this.addStringAt(s, t, n, o))
                    ...
                    (e = [
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                ...
                                return (
                                    ((e =
                                            t.code.includes("Numpad") || t.code.includes("Shift") || t.code.includes("Space") || t.code.includes("Backspace") || t.code.includes("Control") || t.code.includes("Alt") || t.code.includes("Meta")
                                                ? t.code
                                                : t.key) !== e.toUpperCase() ||
            ...
            var s = (function () {
                function SimpleKeyboard() {
                    ...
                    var a = this.handleParams(n),
                        ...
                        l = void 0 === c ? {} : c;
                    if (
                        ((this.utilities = new o({ getOptions: this.getOptions, getCaretPosition: this.getCaretPosition, dispatch: this.dispatch })),
                        ...
                        window.SimpleKeyboardInstances || (window.SimpleKeyboardInstances = {}),
                            ...
                            (this.physicalKeyboard = new i({ dispatch: this.dispatch, getOptions: this.getOptions })),
                            !this.keyboardDOM)
                    )
                    ...
                    (e = [
                        {
                            ...
                            value: function (t) {
                                ...
                                if (this.input[this.options.inputName] !== n && (!this.options.inputPattern || (this.options.inputPattern && this.inputPatternIsValid(n)))) {
                                    ...
                                    (this.input[this.options.inputName] = this.utilities.getUpdatedInput(t, this.input[this.options.inputName], this.caretPosition, !0)),
                                    ...
                                    "function" === typeof this.options.onChangeAll && this.options.onChangeAll(this.input);
                                }
                        ...
                        },
                        {
                            ...
                            value: function (t, e) {
                                ...
                                (this.holdTimeout = setTimeout(function () {
                                    !n.isMouseHold ||
                                    ((t.includes("{") || t.includes("}")) && "{delete}" !== t && "{backspace}" !== t && "{bksp}" !== t && "{space}" !== t && "{tab}" !== t) ||
                                ...
                                t.target.tagName && (e = t.target.tagName.toLowerCase()),
                                    this.dispatch(function (n) {
                                        n.isMouseHold && (n.isMouseHold = !1),
                                            ("textarea" !== e && "input" !== e) || n.options.disableCaretPositioning
                                                ? n.options.disableCaretPositioning && (n.caretPosition = null)
                                                : ((n.caretPosition = t.target.selectionStart), n.options.debug && console.log("Caret at: ", t.target.selectionStart, t.target.tagName.toLowerCase(), "(".concat(n.keyboardDOMClass, ")")));
                                    });
                            },
                        },
                        {
                        ...
                        },
                        {
                            ...
                            value: function (t, e) {
                                ...
                                n.forEach(function (n) {
                                    n.attribute && "string" === typeof n.attribute && n.value && "string" === typeof n.value && n.buttons && "string" === typeof n.buttons
                                        ? n.buttons.split(" ").includes(t) && e(n.attribute, n.value)
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                (this.keyboardDOM.className = this.getKeyboardClassString(this.options.theme, e, this.keyboardPluginClasses, i)),
