...
public class ZoomedEvent extends GwtEvent<ZoomedEvent.ZoomedHandler> {
    ...
    private SerialZoomedEventData data;

    public ZoomedEvent(SerialZoomedEventData data) {
        this.data = data;
    }
    ...
    public static void fire(HasHandlers source, SerialZoomedEventData data) {
    ...
    @Override
    protected void dispatch(ZoomedHandler handler) {
        handler.onZoomedEvent(this);
    }

    public SerialZoomedEventData getData() {
        return data;
    }

    public interface ZoomedHandler extends EventHandler {
        void onZoomedEvent(ZoomedEvent event);
    }
}
