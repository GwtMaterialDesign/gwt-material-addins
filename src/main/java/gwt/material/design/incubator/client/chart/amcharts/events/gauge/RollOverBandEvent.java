 ...
 * @author kevzlou7979
 */
public class RollOverBandEvent extends GwtEvent<RollOverBandEvent.ClickLabelHandler> {
    ...
    @Override
    protected void dispatch(RollOverBandEvent.ClickLabelHandler handler) {
