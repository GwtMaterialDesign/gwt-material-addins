...
public class PreviousEvent extends GwtEvent<PreviousEvent.PreviousHandler> {
    ...
    public static final Type<PreviousHandler> TYPE = new Type<>();

    public static void fire(HasHandlers source) {
        source.fireEvent(new PreviousEvent());
    }

    @Override
    public Type<PreviousHandler> getAssociatedType() {
        return TYPE;
    }

    @Override
    protected void dispatch(PreviousHandler handler) {
