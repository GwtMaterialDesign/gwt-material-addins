...
public class MaterialCarouselDarkTheme extends AddinsWidgetDarkTheme {

    public MaterialCarouselDarkTheme() {
        super(MaterialAddins.isDebug() ? MaterialCarouselDebugClientBundle.INSTANCE.carouselDarkCss() : MaterialCarouselClientBundle.INSTANCE.carouselDarkCss());
    }
}
